[合集 \- 大模型(12\)](https://github.com)[1\.【大语言模型基础】GPT（Generative Pre\-training ）生成式无监督预训练模型原理2023\-04\-15](https://github.com/justLittleStar/p/17322259.html)[2\.【大语言模型基础】图解GPT原理\-60行numpy实现GPT2023\-12\-26](https://github.com/justLittleStar/p/17925108.html)[3\.【LLM应用】基于GPT3\.5的代码编辑器Cursor试用\-智能代码编辑助手2023\-04\-16](https://github.com/justLittleStar/p/17324166.html)[4\.【大语言模型基础】Transformer模型Torch代码详解和训练实战2023\-10\-24](https://github.com/justLittleStar/p/17786071.html)[5\.【LLM】在Colab上使用免费T4 GPU进行Chinese\-Llama\-2\-7b\-4bit推理2023\-10\-06](https://github.com/justLittleStar/p/17745291.html)[6\.【大语言模型基础】\-详解Transformer原理2023\-04\-15](https://github.com/justLittleStar/p/17322172.html)[7\.【LLM实战】 基于QLoRA微调微软Phi\-2的对话摘要任务2024\-03\-13](https://github.com/justLittleStar/p/18071717)[8\.大模型高效微调详解\-从Adpter、PrefixTuning到LoRA2024\-05\-06](https://github.com/justLittleStar/p/18176230)[9\.大模型高效微调\-LoRA原理详解和训练过程深入分析2024\-06\-11](https://github.com/justLittleStar/p/18242820):[蓝猫加速器官网](https://baoshidao.com)[10\.【LLM训练系列】NanoGPT源码详解和中文GPT训练实践2024\-08\-25](https://github.com/justLittleStar/p/18379771)[11\.【LLM训练系列】从零开始训练大模型之Phi2\-mini\-Chinese项目解读2024\-09\-09](https://github.com/justLittleStar/p/18405618)12\.Qwen2ForSequenceClassification文本分类实战和经验分享01\-12收起
本文主要使用Qwen2ForSequenceClassification实现文本分类任务。


文章首发于我的知乎：[https://zhuanlan.zhihu.com/p/17468021019](https://github.com)
...
ps：结论和，[https://segmentfault.com/a/1190000044485544\#item\-13，基本一致](https://github.com)
...
```
SequenceClassifierOutputWithPast(loss=None, logits=tensor([[-0.1387,  2.3438]], device='cuda:0', grad_fn=), past_key_values=((tensor([[[[ -3.3750,   0.3164,   2.3125,  ...,  56.5000,  26.0000,  87.0000],
...
2024-10-09 23:54:07.615 | INFO     | __main__::53 - start Trainingrank: 64
...
```
2024-10-09 23:54:17.371 | INFO     | __main__::56 - Valid Set, rank: 64
4it [00:00,  8.03it/s]
2024-10-09 23:54:17.896 | INFO     | __main__::59 - None
2024-10-09 23:54:17.897 | INFO     | __main__::61 - Test Set, rank: 64
Accuracy: 1.0
micro Precision: 1.0
micro Recall: 1.0
micro F1 Score: 1.0
...
2024-10-09 23:54:18.218 | INFO     | __main__::64 - None
Accuracy: 0.75
...
* 比较详细的LLM分类头微调经验
[https://zhuanlan.zhihu.com/p/704983302](https://github.com)
* 在灾难推文分析场景上比较用 LoRA 微调 Roberta、Llama 2 和 Mistral 的过程及表现
[https://segmentfault.com/a/1190000044485544](https://github.com)
* SFT分类头微调代码（其实就是去掉LoRA那几行代码）
[https://github.com/muyaostudio/qwen2\_seq\_cls](https://github.com)
* 知乎上的一个代码
[https://zhuanlan.zhihu.com/p/691459595](https://github.com)
